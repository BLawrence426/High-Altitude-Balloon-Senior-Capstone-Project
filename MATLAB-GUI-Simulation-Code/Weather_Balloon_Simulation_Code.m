...
figure(1)
plot(Time_Table,Temperature_Table - 273.15,'r')
hold on
plot(HAB_Time_Seconds,HAB_Ext_Temp,'b')
grid on
xlabel('Time (Seconds)')
...
figure(2)
plot(Time_Table,Pressure_Table/6894.76,'r')
hold on
plot(HAB_Time_Seconds,HAB_Pressure,'b')
grid on
xlabel('Time (Seconds)')
ylabel('Pressure (psi)')
...
figure(3)
plot(Time_Table,Altitude_Table*3.28084,'r')
hold on
plot(HAB_Time_Seconds,Pressure_Altitude,'b')
grid on
xlabel('Time (Seconds)')
