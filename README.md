...
So overall, the website we used to estimate the flight path was pretty close to the one the balloon actually followed which is incredible. Likewise, the balloon appeared to have preformed even better than intended since it drifted about 20 miles further east than we expected. This leads us to believe that the balloon reached an altitude closer to 110,000 ft instead of the anticipated 100,000 ft. And speaking of which, these following two plots of both the GPS altitude and the pressure corresponding to the recorded pressures were created:
